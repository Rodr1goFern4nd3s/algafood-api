...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleValidationInternal(Exception ex, HttpHeaders headers, HttpStatus status, WebRequest request, BindingResult bindingResult) {
    ...
    public ResponseEntity<Object> handleUncaught(Exception ex, WebRequest request) {
        //Método tratará Exceptions genéricas não tratadas.
